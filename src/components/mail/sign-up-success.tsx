...
const baseUrl = websiteConfig.basicInfo.baseUrl;
...
export const WelcomeEmail = ({ steps, links }: WelcomeEmailProps) => {
  return (
    <Html>
      ...
      >
        <Preview>Welcome to {websiteConfig.basicInfo.title}</Preview>
        <Body className="bg-offwhite font-sans text-base">
          <Container className="bg-white p-45">
            <Heading className="my-0 text-center leading-8">
              Welcome to {websiteConfig.basicInfo.title}
            </Heading>
            ...
            <Section>
              <Row>
                <Text className="text-base">
                  ...
                  around the world who use {websiteConfig.basicInfo.title} to
                  build and ship sites, stores, and apps.
                </Text>
          ...
          <Container className="mt-20">
            ...
            <Text className="mb-45 text-center text-gray-400">
              {websiteConfig.basicInfo.title}, 44 Montgomery Street, Suite 300
              San Francisco, CA
            </Text>
          </Container>
        </Body>
